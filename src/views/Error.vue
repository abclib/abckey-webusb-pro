...
export default {
  ...
  i18n: {
    messages: {
      zhCN: {
        'Back to home': '回到主页',
        'Please check that the URL you entered is correct, or click the button below to return to the homepage.': '请检查你输入的网址是否正确,或者点击下面的返回按扭.',
        '404 Page Not Found': '未找到目标页面',
        'OOPS!': 'OOPS!',
